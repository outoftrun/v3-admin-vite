...
const querySuccess = async () => {
  ...
  // 2. If you need to give To pass parameters to the getSuccessApi function, please do it in the brackets behind (the real getSuccessApi call)
...
<template>
  <div class="app-container">
    <h4>
      This example demonstrates: by passing the function to be executed to the hook, the hook automatically turns on
      full-screen loading, and automatically turns off loading after the function is executed
    </h4>
